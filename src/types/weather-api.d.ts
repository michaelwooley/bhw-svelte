...
export declare interface StationObservation {
  id: string;
  type: "Feature";
  geometry: {
    type: "Point";
 ...
 */
export declare interface WeatherApiStationObservationLatest
  extends StationObservation {
 ...
 */
export declare interface WeatherApiStationObservations {
  context: WeatherApiContext;
